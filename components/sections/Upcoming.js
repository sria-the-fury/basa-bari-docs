                            ...
                            <div className={styles.cardContainer}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.cardText}>
                                        <p>Implementing google map to find the rental home on the map easily around the users. Listing will be in the map as marked view.</p>
                                        <p>Landlord will add their building listing by searching places and these listings will be shown in the map marked view.</p>
                                    </div>
                        ...
                        <ScrollAnimation animateIn='flipInY'
                            ...
                            <div className={styles.cardContainer}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.cardText}>
                                        <p>Everyone wants to earn some. I have too this vision. That's why I will integrate the mobile payment method such users can easily pay their payment while adding their building's listing.</p>
                        ...
                        <ScrollAnimation animateIn='flipInY'
                            ...
                            <div className={styles.cardContainer}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.cardText}>
                                        <p>This design is chose as primary design for this android application.
                                            I think, this is not the better design for the users. But as a startup, I hope this enough as I am solely developing this. </p>
                        ...
                        <ScrollAnimation animateIn='flipInY'
                            ...
                            <div className={styles.cardContainer}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.cardText}>
                                        <p>My first target is the android playStore market for deploy the application in the market. But iOS version (AppStore) will be coming in a short time after deploying for playStore.</p>
